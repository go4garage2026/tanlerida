  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#0A0A0A] px-6 text-center">
      <div className="max-w-xl border border-[#2A2A2A] bg-[#111111] p-10">
        ...
        <p className="mt-4 text-sm leading-7 text-[#A0A0A0]">The route you requested could not be found. Return to the Tangred storefront or explore Tan Lerida from the main collection.</p>
