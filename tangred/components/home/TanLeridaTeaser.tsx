    ...
    <section className="relative overflow-hidden border-y border-[#2A2A2A] bg-[#111111] px-6 py-20 md:px-10 lg:px-16">
      ...
      <div className="relative mx-auto max-w-[1100px] text-center">
        ...
        <p className="mx-auto mt-6 max-w-2xl text-base text-[#A0A0A0] md:text-lg">
          Tan Lerida studies your profile, interprets your wardrobe intent, matches you to Tangred’s catalogue, and presents your most flattering leather recommendation.
        </p>
        <Link href="/tan-lerida/payment" className="btn-red mt-10">
